# -*- coding: utf-8 -*-
"""
Created on Tue Feb 09 10:02:19 2016
...
All received events (from tobi and noldus and wear) are stored into buffer and send as vector upon http request. When data is sent, buffer is cleared.
For developmnet purposes, until no data is received from noldus and tobii and wear the app is sending "placeholder" data repeatedly. Placeholder data is in format of actual data.
...
#wearSocketAddress="192.168.81.88"
