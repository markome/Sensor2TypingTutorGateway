...
serverHostPort=8080
global tobiiServerHostRoute
#tobiiServerHostRoute='/facereader'
tobiiServerHostRoute='/tobii'
facereaderServerHostRoute='/noldus'
...
@app.route(tobiiServerHostRoute, method=['OPTIONS', 'GET'])
...
@app.route(facereaderServerHostRoute, method=['OPTIONS', 'GET'])
def faceReaderDataResponder():
    response.headers['Content-type'] = 'application/json'
    #i=i+1
    global i
    i=i+1
...
print 'Starting http server on http://',serverHostIP,':',serverHostPort,tobiiServerHostRoute
